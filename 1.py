...
class Manager(Employee):
    ...
    def __init__(self, employee_id, name, base_salary,
                 department, bonus_percent, team_size):
        """
    ...
    def get_info(self):
        ...
        return (f"{base_info}, Должность: Менеджер, "
                f"Команда: {self.team_size} чел.")
...
class Developer(Employee):
    ...
    def __init__(self, employee_id, name, base_salary,
                 ...
                 experience_years, overtime_hours, overtime_rate):
        """
    ...
    def get_info(self):
        ...
        base_info = super().get_info()
        return (f"{base_info}, Должность: Разработчик, "
...
class Company:
    ...
    def remove_employee(self, employee_id):
        ...
        self.employees = [e for e in self.employees
                          if e.employee_id != employee_id]

    def calculate_total_payroll(self):
        """Рассчитывает общий фонд заработной платы."""
...
print(f"Зарплата менеджера {manager1.name}: "
      f"{manager1.calculate_salary():.2f} руб.")
print(f"Зарплата разработчика {developer1.name}: "
      f"{developer1.calculate_salary():.2f} руб.\n")
