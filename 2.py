class Vehicle:
    ...
    def __init__(self, brand, model, year, max_speed, fuel_type):
        """
    ...
    def get_description(self):
        ...
        """
        return f"{self.brand} {self.model} ({self.year}), Макс. скорость: {self.max_speed} км/ч, Топливо: {self.fuel_type}"
...
class Car(Vehicle):
    ...
    def __init__(self, brand, model, year, max_speed, fuel_type, doors, body_type, trunk_capacity):
        """
    ...
    def get_description(self):
        ...
        return f"Автомобиль: {base_description}, Двери: {self.doors}, Кузов: {self.body_type}, Багажник: {self.trunk_capacity} л"
    ...
    def start_engine(self):
        ...
        """
        return "Двигатель автомобиля запущен с помощью ключа или кнопки"
...
class Motorcycle(Vehicle):
    ...
    def __init__(self, brand, model, year, max_speed, fuel_type, engine_cc, bike_type, has_sidecar=False):
        """
    ...
    def get_description(self):
        ...
        return f"Мотоцикл: {base_description}, Объем: {self.engine_cc} см³, Тип: {self.bike_type}, {sidecar_info}"
    ...
    def start_engine(self):
        ...
        """
        return "Двигатель мотоцикла запущен с помощью кик-стартера или кнопки"
...
class Truck(Vehicle):
    ...
    def __init__(self, brand, model, year, max_speed, fuel_type, cargo_capacity, axle_count, trailer_type):
        """
    ...
    def get_description(self):
        ...
        """
        base_description = super().get_description()
        return f"Грузовик: {base_description}, Грузоподъемность: {self.cargo_capacity} т, Оси: {self.axle_count}, Прицеп: {self.trailer_type}"
    ...
    def start_engine(self):
        ...
        """
        return "Двигатель грузовика запущен, требуется прогрев перед началом движения"
...
class Bus(Vehicle):
    ...
    def __init__(self, brand, model, year, max_speed, fuel_type, passenger_capacity, bus_type, has_air_conditioning):
        """
    ...
    def get_description(self):
        ...
        """
        base_description = super().get_description()
        ac_info = "с кондиционером" if self.has_air_conditioning else "без кондиционера"
        return f"Автобус: {base_description}, Вместимость: {self.passenger_capacity} пасс., Тип: {self.bus_type}, {ac_info}"
    ...
    def start_engine(self):
        ...
        """
        return "Двигатель автобуса запущен, проверка систем завершена"
...
motorcycle1 = Motorcycle("Harley-Davidson", "Sportster", 2021, 180, "Бензин", 1200, "Круизер", False)
truck1 = Truck("Volvo", "FH16", 2020, 120, "Дизель", 25, 3, "Рефрижератор")
bus1 = Bus("Mercedes-Benz", "Sprinter", 2023, 140, "Дизель", 20, "Микроавтобус", True)

# Создаем список всех транспортных средств
vehicles = [car1, motorcycle1, truck1, bus1]

# Демонстрация полиморфизма: вызов метода get_description() для каждого объекта
print("\n=== ПОЛИМОРФИЗМ: ВЫЗОВ МЕТОДА get_description() ===")
for i, vehicle in enumerate(vehicles, 1):
    print(f"{i}. {vehicle.get_description()}")

# Демонстрация полиморфизма: вызов метода start_engine() для каждого объекта
...
car2 = Car("Tesla", "Model S", 2023, 250, "Электричество", 4, "Седан", 793)
motorcycle2 = Motorcycle("Honda", "CBR600RR", 2022, 240, "Бензин", 599, "Спортивный", False)
truck2 = Truck("MAN", "TGX", 2021, 110, "Дизель", 18, 2, "Тентованный")
bus2 = Bus("ЛиАЗ", "5292", 2020, 90, "Газ", 85, "Городской", False)

# Список всех транспортных средств
all_vehicles = [car1, car2, motorcycle1, motorcycle2, truck1, truck2, bus1, bus2]
